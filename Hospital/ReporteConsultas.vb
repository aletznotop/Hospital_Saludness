...
Public Class ReporteConsultas
    ...
    Private Sub printDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("Reporte de Consultas " + Now, printFont, System.Drawing.Brushes.Red, (leftMargin / 2) - 50, 20)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Try
                ...
                conexion.Open()
                sql = "select id_consulta,fecha,descripcion from consultas where fecha BETWEEN '" & desde.Text() & "' and '" & hasta.Text() & "';"
                ...
                If rs.HasRows = True Then
                    ...
                    conexion.Close()
                Else
                    MsgBox("No hay datos en la fecha señalada")
                End If
    ...
    Private Sub ReporteConsultas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
