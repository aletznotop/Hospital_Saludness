...
Public Class registroUsuarios
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If tipoUsuario.Text() = "" Or nombreUsuario.Text() = "" Or apmUsuario.Text() = "" Or appUsuario.Text() = "" Or passContrasena.Text() = "" Or conContrasena.Text() = "" Then
            MsgBox("No puede haber texto vacío, verifique")
        ElseIf passContrasena.Text() <> conContrasena.Text() Then
